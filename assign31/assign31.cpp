...
enum PieceType {NONE = 0, KING = 1, QUEEN = 2, PAWN = 3};
...
void bind(Piece * pThis, PieceType pt, bool isWhite)
{
   ...
   static VTablePiece vTableGetLetterKing = {&getLetterKing};
   static VTablePiece vTableGetLetterQueen = {&getLetterQueen};
   static VTablePiece vTableGetLetterPawn = {&getLetterPawn};
   ...
   switch (pt)
   {
      default:
         assert(false);
      case KING:
         pThis->__vtptr = &vTableGetLetterKing;
         break;
      case QUEEN:
         pThis->__vtptr = &vTableGetLetterQueen;
         break;
      case PAWN:
         pThis->__vtptr = &vTableGetLetterPawn;
         break;
      case NONE:
         break;
   }
